...
class WPSS_WpSus_Activation {
	...
	private static function single_activate() {
		...
		if ( $wpdb->get_var( "SHOW TABLES LIKE '$table_name'" ) != $table_name ) {
			...
			$create_slides_table = "CREATE TABLE ". $prefix . "wp_sus_slides (
				id mediumint(9) NOT NULL AUTO_INCREMENT,
			...
			$create_layers_table = "CREATE TABLE ". $prefix . "wp_sus_layers (
				id mediumint(9) NOT NULL AUTO_INCREMENT,
				slider_id mediumint(9) NOT NULL,
			...
			update_option( 'wpsus_version', WPSS_WpSus::VERSION );
		}
