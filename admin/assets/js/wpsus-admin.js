    ...
    var WpSusAdmin = {
        ...
        loadSliderData: function() {
            ...
            $.ajax({
                url: sp_js_vars.ajaxurl,
                type: 'get',
                data: { action: 'wpsus_get_slider_data', id: sp_js_vars.id, nonce: sp_js_vars.lad_nonce },
                complete: function(data) {
            ...
            $.ajax({
                ...
                complete: function(data) {
                    ...
                    if (parseInt(sp_js_vars.id, 10) === -1 && isNaN(data.responseText) === false) {
                        ...
                        window.location = sp_js_vars.admin + '?page=wpsus&id=' + data.responseText + '&action=edit';
