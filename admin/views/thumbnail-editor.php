        ...
        ?>
            <div class="inline-info thumbnail-editor-info">
				...
				<div class="info-content">
	                ...
	                <p><?php _e( 'The <i>Thumbnail Content</i> field allows you to add content (from simple text to any HMTL content) to the thumbnails. Also, you can add the image specified in the <i>Thumbnail Image</i> field inside the <i>Thumbnail Content</i> field by using the <i>[sp_thumbnail_image]</i> shortcode.', 'wpsus' ); ?></p>
