<div class="breakpoint">
	<table>
		<thead class="breakpoint-header">
			<tr>
				<th>
					<label><?php _e( 'Window width:', 'wpsus' ); ?></label>
				</th>
				<th>
	...
	<div class="add-breakpoint-setting-group">
        <a class="button add-breakpoint-setting" href="#"><?php _e( 'Add Setting', 'wpsus' ); ?> <span class="add-breakpoint-setting-arrow">&#9660</span></a>
        <ul class="breakpoint-setting-name">
        	<?php
				$default_breakpoint_settings = WPSS_WpSus_Settings::getBreakpointSettings();
