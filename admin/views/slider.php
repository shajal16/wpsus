<div class="wrap wpsus-admin">
	<h2><?php echo isset( $_GET['action'] ) && $_GET['action'] === 'edit' ? __( 'Edit Slider', 'wpsus' ) : __( 'Add New Slider', 'wpsus' ); ?></h2>
    <div class="postbox action">
					<div class="inside">
						<input type="submit" name="submit" class="button-primary" value="<?php echo isset( $_GET['action'] ) && $_GET['action'] === 'edit' ? __( 'Update', 'wpsus' ) : __( 'Create', 'wpsus' ); ?>" />
                        <span class="spinner update-spinner"></span>
						<a class="button preview-slider" href="#"><?php _e( 'Preview', 'wpsus' ); ?></a>
    	...
    	<div class="metabox-holder has-right-sidebar">
            <div class="editor-wrapper">
                <div class="editor-body">
                    ...
                    <div class="add-slide-group">
                        <a class="button add-slide" href="#"><?php _e( 'Add Slides', 'wpsus' ); ?> <span class="add-slide-arrow">&#9660</span></a>
                        <ul class="slide-type">
                            <li><a href="#" data-type="image"><?php _e( 'Image Slides', 'wpsus' ); ?></a></li>
                            <li><a href="#" data-type="posts"><?php _e( 'Posts Slides', 'wpsus' ); ?></a></li>
                            <li><a href="#" data-type="gallery"><?php _e( 'Gallery Slides', 'wpsus' ); ?></a></li>
                            <li><a href="#" data-type="flickr"><?php _e( 'Flickr Slides', 'wpsus' ); ?></a></li>
                            <li><a href="#" data-type="empty"><?php _e( 'Empty Slide', 'wpsus' ); ?></a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="inner-sidebar meta-box-sortables ui-sortable">
                ...
                <div class="sidebar-settings">
                    <?php
                        $setting_groups = WPSS_WpSus_Settings::getSettingGroups();
                        $panels_state = WPSS_WpSus_Settings::getPanelsState();
                    ?>
                    ...
                    <div class="postbox <?php echo $panel_class; ?>" data-name="presets">
                        ...
                        <h3 class="hndle"><?php _e( 'Presets', 'wpsus' ); ?></h3>
                        <div class="inside">
                            <?php
                                ...
                                if ( $presets === false || empty( $presets ) ) {
                                    ...
                                    $default_settings = WPSS_WpSus_Settings::getSettings();
                                ...
                                echo '<label for="slider-setting-presets">' . __( 'Saved Presets', 'wpsus' ) . '</label>';
                                ...
                                $save_new_preset_url = admin_url( 'admin.php?page=wpsus&action=update-presets&method=save-new' ) . '&up_nonce=' . $update_presets_nonce;
                                $update_preset_url = admin_url( 'admin.php?page=wpsus&action=update-presets&method=update' ) . '&up_nonce=' . $update_presets_nonce;
                                $delete_preset_url = admin_url( 'admin.php?page=wpsus&action=update-presets&method=delete' ) . '&up_nonce=' . $update_presets_nonce;

                                echo '<a href="' . $save_new_preset_url . '" class="button update-presets">' . __( 'Save New', 'wpsus' ) . '</a>';
                                echo ' <a href="' . $update_preset_url . '" class="button update-presets">' . __( 'Update Preset', 'wpsus' ) . '</a>';
                                echo ' <a href="' . $delete_preset_url . '" class="button update-presets">' . __( 'Delete Preset', 'wpsus' ) . '</a>';
                            ...
                            ?>
                                <div class="inline-info presets-info">
                                    ...
                                    <label for="show-hide-presets-info" class="show-info"><?php _e( 'Show info', 'wpsus' ); ?></label>
                                    <label for="show-hide-presets-info" class="hide-info"><?php _e( 'Hide info', 'wpsus' ); ?></label>
                                    
                                    <div class="info-content">
                                        <p><?php _e( 'You can save setting configuration in order to easily reuse them for other sliders. After you decided on a certain configuration you just need to click on the <i>Save New</i> button and then you will be prompted to specify a name for the saved preset. The preset will then be saved and added to the list of saved presets. You can later update the configuration of a certain preset or delete it if you want.', 'wpsus' ); ?></p>
                                    </div>
                                </div>
                            <?php
                                }
                                ...
                                <div class="inside">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach ( $group['list'] as $setting_name ) {
                                                    $setting = WPSS_WpSus_Settings::getSettings( $setting_name );
                                            ?>
                                                    <tr>
                                                        <td>
                                    ...
                                    ?>
                                            <div class="inline-info sidebar-slide-info">
                                                ...
                                                <label for="show-hide-<?php echo $group_name; ?>-info" class="show-info"><?php _e( 'Show info', 'wpsus' ); ?></label>
                                                <label for="show-hide-<?php echo $group_name; ?>-info" class="hide-info"><?php _e( 'Hide info', 'wpsus' ); ?></label>
                    ...
                    <div class="postbox breakpoints-box <?php echo $panel_class; ?>" data-name="breakpoints">
                        <div class="handlediv"></div>
                        <h3 class="hndle"><?php _e( 'Breakpoints', 'wpsus' ); ?></h3>
                        <div class="inside">
                            ...
                            <a class="button add-breakpoint" href="#"><?php _e( 'Add Breakpoint', 'wpsus' ); ?></a>
                            <?php
                                $hide_info = get_option( 'wpsus_hide_inline_info' );
                            ...
                            ?>
                                <div class="inline-info breakpoints-info">
                                    ...
                                    <label for="show-hide-breakpoint-info" class="show-info"><?php _e( 'Show info', 'wpsus' ); ?></label>
                                    <label for="show-hide-breakpoint-info" class="hide-info"><?php _e( 'Hide info', 'wpsus' ); ?></label>
                                    
                                    <div class="info-content">
                                        <p><?php _e( 'Breakpoints allow you to modify the look of the slider for different window sizes.', 'wpsus' ); ?></p>
                                        <p><?php _e( 'Each breakpoint allows you to set the width of the window for which the breakpoint will apply, and then add several settings which will override the global settings.', 'wpsus' ); ?></p>
                                        <p><a href="https://www.youtube.com/watch?v=LKcpUz6K70w&list=PLh-6IaZNuPo4MHvfzrTovXRuU7WKXkfWh" target="_blank"><?php _e( 'See the video tutorial', 'wpsus' ); ?> &rarr;</a></p>
                                    </div>
                                </div>
                            <?php
                                }
