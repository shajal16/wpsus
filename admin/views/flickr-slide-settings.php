<tr>
	<td class="label-cell">
		<label for="flickr-api-key"><?php _e( 'API Key', 'wpsus' ); ?>:</label>
	</td>
...
<tr>
	<td class="label-cell">
		<label for="flickr-load-by"><?php _e( 'Load By', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="flickr-id"><?php _e( 'ID', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="flickr-limit"><?php _e( 'Limit', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
        ...
        ?>
            <div class="inline-info slide-settings-info">
				...
				<div class="info-content">
            		<p><?php _e( 'One <i>Flickr</i> slide in the admin area will dynamically generate multiple slides in the published slider (one slide for each Flickr image loaded), based on the set parameters.', 'wpsus' ); ?></p>
                	<p><?php _e( 'First, you need to request an API key', 'wpsus' ); ?> <a href="https://www.flickr.com/services/apps/create/apply/"><?php _e( 'here', 'wpsus' ); ?></a> <?php _e( 'and then specify it in the <i>API Key</i> field above.', 'wpsus' ); ?></p>
                	<p><?php _e( 'In the <i>ID</i> field you need to enter the id of the set or the id of the username, depending on the <i>Load by</i> selection.', 'wpsus' ); ?></p>
