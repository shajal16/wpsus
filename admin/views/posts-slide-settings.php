<tr>
	<td class="label-cell">
		<label for="posts-post-types"><?php _e( 'Post Types', 'wpsus' ); ?>:</label>
	</td>
...
<tr>
	<td class="label-cell">
		<label for="posts-taxonomies"><?php _e( 'Taxonomies', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="posts-relation"><?php _e( 'Match', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="posts-operator"><?php _e( 'With selected', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="posts-order-by"><?php _e( 'Order By', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="posts-order"><?php _e( 'Order', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
...
<tr>
	<td class="label-cell">
		<label for="posts-maximum"><?php _e( 'Limit', 'wpsus' ); ?>:</label>
	</td>
	<td class="setting-cell">
        ...
        ?>
            <div class="inline-info slide-settings-info">
				...
				<div class="info-content">
                	<p><?php _e( 'One <i>Posts</i> slide in the admin area will dynamically generate multiple slides in the published slider (one slide for each loaded post), based on the set parameters.', 'wpsus' ); ?></p>
                	<p><?php _e( 'The list of taxonomies will be refreshed every time the list of post types is updated.', 'wpsus' ); ?></p>
                	<p><?php _e( 'The <i>Match</i> parameter indicates whether, in order to be fetched, a post needs to have all the selected taxonomy terms, or at least one will be sufficient. The <i>With selected</i> parameter indicates whether posts that include the selected taxonomy terms will be loaded, or if posts that don\'t include them will be loaded.', 'wpsus' ); ?></p>
                	...
                	<p><a href="https://www.youtube.com/watch?v=LARRTKJrz8U&list=PLh-6IaZNuPo4MHvfzrTovXRuU7WKXkfWh" target="_blank"><?php _e( 'See the video tutorial', 'wpsus' ); ?> &rarr;</a></p>
            	</div>
            </div>
        <?php
            }
