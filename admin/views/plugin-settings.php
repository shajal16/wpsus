<div class="wrap wpsus-admin plugin-settings">
	<h2><?php _e( 'Plugin Settings', 'wpsus' ); ?></h2>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="button-secondary clear-all-cache" data-nonce="<?php echo wp_create_nonce( 'clear-all-cache' ); ?>"><?php _e( 'Clear all cache now', 'wpsus' ); ?></a>
