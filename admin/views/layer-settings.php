<li id="layer-settings-<?php echo esc_attr( $layer_id ); ?>" class="layer-settings" data-id="<?php echo esc_attr( $layer_id ); ?>">
	<ul>
		<li>
			...
			<label for="content-tab-<?php echo esc_attr( $layer_id ); ?>" class="layer-settings-tab-label"><?php _e( 'Content', 'wpsus' ); ?></label>
				...
				?>
						<table>
							<tbody>
								<tr>
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-heading-type" class="heading-type-label"><?php _e( 'Heading Type', 'wpsus' ); ?></label>
				...
				?>
						<table>
							<tbody>
								<tr>
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-image-source"><?php _e( 'Source', 'wpsus' ); ?></label>
									...
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-image-alt"><?php _e( 'Alt', 'wpsus' ); ?></label>
								...
								<tr>
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-image-link"><?php _e( 'Link', 'wpsus' ); ?></label>
									...
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-image-retina"><?php _e( 'Retina', 'wpsus' ); ?></label>
										<div class="layer-image-input">
				...
				?>
						<table>
							<tbody>
								<tr>
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-source"><?php _e( 'Source', 'wpsus' ); ?></label>
									...
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-id"><?php _e( 'ID', 'wpsus' ); ?></label>
									...
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-load-mode"><?php _e( 'Load Mode', 'wpsus' ); ?></label>
									...
									<td>
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-params"><?php _e( 'Params', 'wpsus' ); ?></label>
								...
								<tr>
									<td colspan="2">
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-poster"><?php _e( 'Poster', 'wpsus' ); ?></label>
										<div class="layer-image-input">
									...
									<td colspan="2">
										<label for="layer-<?php echo esc_attr( $layer_id ); ?>-video-retina-poster"><?php _e( 'Retina Poster', 'wpsus' ); ?></label>
										<div class="layer-image-input">
		...
		<li>
			...
			<label for="appearance-tab-<?php echo esc_attr( $layer_id ); ?>" class="layer-settings-tab-label"><?php _e( 'Appearance', 'wpsus' ); ?></label>
			<div class="layer-setting-fields">
				<table>
					<tbody>
						<tr>
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-display"><?php _e( 'Display', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-horizontal"><?php _e( 'Horizontal', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-width"><?php _e( 'Width', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-preset-styles"><?php _e( 'Preset styles', 'wpsus' ); ?></label>
						...
						<tr>
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-position"><?php _e( 'Position', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-vertical"><?php _e( 'Vertical', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-height"><?php _e( 'Height', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-custom-class"><?php _e( 'Custom Class', 'wpsus' ); ?></label>
		...
		<li>
			...
			<label for="animation-tab-<?php echo esc_attr( $layer_id ); ?>" class="layer-settings-tab-label"><?php _e( 'Animation', 'wpsus' ); ?></label>
			<div class="layer-setting-fields">
				<table>
					<tbody>
						<tr>
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-show-transition"><?php _e( 'Show Transition', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-show-offset"><?php _e( 'Show Offset', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-show-delay"><?php _e( 'Show Delay', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-show-duration"><?php _e( 'Show Duration', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-stay-duration"><?php _e( 'Stay Duration', 'wpsus' ); ?></label>
						...
						<tr>
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-hide-transition"><?php _e( 'Hide Transition', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-hide-offset"><?php _e( 'Hide Offset', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-hide-delay"><?php _e( 'Hide Delay', 'wpsus' ); ?></label>
							...
							<td>
								<label for="layer-<?php echo esc_attr( $layer_id ); ?>-hide-duration"><?php _e( 'Hide Duration', 'wpsus' ); ?></label>
