...
class WPSS_SP_Slide_Renderer {
	...
	protected function create_main_image() {
		$main_image_source = $this->lazy_loading === true ? ' src="' . plugins_url( 'wpsus/public/assets/css/images/blank.gif' ) . '" data-src="' . esc_attr( $this->data['main_image_source'] ) . '"' : ' src="' . esc_attr( $this->data['main_image_source'] ) . '"';
	...
	protected function create_thumbnail_image() {
		...
		$thumbnail_source = $this->lazy_loading === true ? ' src="' . plugins_url( 'wpsus/public/assets/css/images/blank.gif' ) . '" data-src="' . esc_attr( $thumbnail_source ) . '"' : ' src="' . esc_attr( $thumbnail_source ) . '"';
	...
	protected function create_layer( $data ) {
		$layer = WPSS_SP_Layer_Renderer_Factory::create_layer( $data );
