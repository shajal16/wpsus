 ...
 * @since  1.0.0
 */
class WPSS_SP_Slide_Renderer_Factory {
	...
	protected static $registered_types = array(
		'custom' => 'WPSS_SP_Slide_Renderer',
		'posts' => 'WPSS_SP_Posts_Slide_Renderer',
		'gallery' => 'WPSS_SP_Gallery_Slide_Renderer',
		'flickr' => 'WPSS_SP_Flickr_Slide_Renderer'
	);
