 ...
 * @since 1.0.0
 */
class WPSS_SP_Video_Layer_Renderer extends WPSS_SP_Layer_Renderer {
	...
	public function render() {
		...
		$poster_src = $this->lazy_loading === true ? ' src="' . plugins_url( 'wpsus/public/assets/css/images/blank.gif' ) . '" data-src="' . esc_attr( $video_poster ) . '"' : ' src="' . esc_attr( $video_poster ) . '"';
